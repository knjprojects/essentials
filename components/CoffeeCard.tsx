...
export default function CoffeeCard(item:{ id: number;
    name: string;
    price: string;
    volume: string;
    stars: string;
  ...
  return (
      ...
      <View className={`border-12 w-full`}
        style={{
          borderRadius: 40, 
          backgroundColor: themeColors.bgDark, 
          height: ios? height*0.4 : height*0.90, 
        ...
        className="flex-row justify-center">
          ...
          <View className={`px-5 flex-1 justify-between ${ios? 'mt-5': ''}`}>
            ...
            <View style={{
              ...
              <TouchableOpacity 
              onPress={()=>{ 
                //</View>navigation.navigate('Product', {...item}
              }}
              style={{
                shadowColor: 'black',
                shadowRadius: 40,
