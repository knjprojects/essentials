...
import Ionicons from '@expo/vector-icons/Ionicons';//expo vector requires react-native-vector-icons
//import MaterialCommunityIcons from 'react-native-vector-icons/MaterialCommunityIcons';
import { MaterialCommunityIcons } from '@expo/vector-icons'; 
import songs from '../backendreactnative/models/data'
...
const MusicPlayer = () => {
  ...
  const prog = useSharedValue(progress.position);
        ...
        <View style={style.bottomIconContainer}>
          ...
          <TouchableOpacity onPress={changeRepeatMode}>
            <MaterialCommunityIcons
              name={`${repeatMode==='off'? 'repeat-off': repeatMode==='track'? 'repeat-once': repeatMode==='repeat'? 'repeat':'repeat'}`}
              size={30}
